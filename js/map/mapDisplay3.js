var mapDisplay3 = new Phaser.Class({
    ...
    create: function() {
        ...
        this.st26.setInteractive().on('pointerdown', function() { DISLIKE_IT = true; }, this);
        this.st27 = this.add.image(860, 345, 'st3-27');
        this.st27.setInteractive().on('pointerdown', function() { LIKE_IT = true; }, this);
        ...
        this.st42.setInteractive().on('pointerdown', function() { LIKE_IT = true; }, this);
        this.st43 = this.add.image(380, 580, 'st3-43');
        this.st43.setInteractive().on('pointerdown', function() { DISLIKE_IT = true;}, this);
        this.st44 = this.add.image(560, 590, 'st3-44');
        this.st44.setInteractive().on('pointerdown', function() { LIKE_IT = true; }, this);
        this.st45 = this.add.image(720, 590, 'st3-45');
        this.st45.setInteractive().on('pointerdown', function() { LIKE_IT = true; }, this);
        this.st46 = this.add.image(890, 575, 'st3-46');
        this.st46.setInteractive().on('pointerdown', function() { LIKE_IT = true; }, this);
